@props(['x-state'])
<div x-show="{{ $xState }}" x-on:keydown.window.escape="{{ $xState }} = false"
    ...
    <div class="z-50 mx-auto overflow-y-auto rounded shadow-lg modal-container">
        <div x-on:click="{{ $xState }} = false"
