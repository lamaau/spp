<div x-data="dialog" x-init="init" @delete-alert.window="open = true">
    <x-modal x-state="open">
        <div class="items-center md:flex">
            ...
            <div class="mt-4 text-center md:mt-0 md:ml-6 md:text-left">
                <p class="font-bold"><span x-text="title"></span></p>
                <p class="mt-1 text-sm text-gray-700"><span x-text="message"></span></p>
            </div>
        </div>
        <div class="mt-4 text-center md:text-right md:flex md:justify-end">
            <button x-on:click="purge"
