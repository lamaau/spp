    ...
    <div x-bind:class="{ toggleSidebar : 'translate-x-0 ease-out', '-translate-x-full ease-in' : !(toggleSidebar) }"
        ...
        <div>
            <ul class="mt-5">
                ...
                <li x-data="{isOpen: false, isActive: '{{ is_active(['rooms', 'levels'])['status'] }}'}">
                    <div class="relative">
                        <a href="#" x-on:click="isOpen = !isOpen"
                            class="{{ is_active(['rooms', 'levels'])['class'] }}">
                    ...
                    <ul class="ml-16 overflow-hidden font-normal"
                        x-bind:style="isOpen || isActive ? 'height: 5rem' : 'height: 0'">
                        <li>
                ...
                <li>
                    <a href="{{ route('schedule.index') }}" class="{{ is_active('schedules*')['class'] }}">
