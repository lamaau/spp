    <div x-data="{isShow: false}">
        <button class="px-6 py-1 bg-gray-300 hover:bg-gray-400" x-on:click="isShow = true">Save</button>
        <div x-show="isShow" class="absolute top-0 right-0 w-2/3 m-3 md:w-1/3"
            ...
            <div class="flex items-start p-3 space-x-2 bg-white border border-gray-300 rounded-md shadow-lg">
                ...
                <div class="flex-1 space-y-1">
                    <p class="text-base font-medium leading-6 text-gray-700">Successfully saved!</p>
                    <p class="text-sm leading-5 text-gray-600">Anyone with a link can now view this file</p>
                </div>
                <svg class="flex-shrink-0 w-5 h-5 text-gray-400 cursor-pointer" x-on:click="isShow = false"
