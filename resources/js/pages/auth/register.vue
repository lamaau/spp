<template>
  <form class="mt-8 space-y-6">
    ...
    <div class="text-sm font-medium text-gray-500">Tidak terdaftar? <a href="https://t.me/rizkhal" target="_blank" class="text-teal-500 hover:underline">Hubungi admin</a></div>
  </form>
</template>
<script>
